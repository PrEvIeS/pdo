...
class Version20211222050438 extends Version
{
  ...
  'IBLOCK_TYPE_ID' => 'educational_programs',
  'LID' => 
  array (
    0 => 's1',
  ),
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/educational_programs/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/educational_programs/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/educational_programs/list.php?SECTION_ID=#SECTION_ID#',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  array (
    ...
    array (
      ...
      'XML_ID' => 'self',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Документ по итогам обучения',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'DOCUMENT',
  'DEFAULT_VALUE' => '',
  ...
  array (
    0 => 
    array (
      'VALUE' => 'Диплом о профессиональной переподготовке',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'diploma',
    ),
  ...
  array (
    0 => 
    array (
      'VALUE' => 'Программы повышения квалификации',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'development',
    ),
    1 => 
    array (
      'VALUE' => 'Программы профессиональной переподготовки',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'retraining',
    ),
  ...
  array (
    ...
    'PROPERTY_HOURS' => 'Объем часов по программе',
    'PROPERTY_REALISATION_FORM' => 'Форма реализации',
    'PROPERTY_DOCUMENT' => 'Документ по итогам обучения',
    'PROPERTY_PERIOD' => 'Период реализации',
    'PROPERTY_PROGRAMM' => 'Тип программы',
  ),
  'Анонс' => 
  array (
  ...
  array (
    'default' => 
    array (
      'columns' => 'ID,ACTIVE,NAME,PROPERTY_197,PROPERTY_198,PROPERTY_199,PROPERTY_200',
      'columns_sizes' => 
      array (
        'expand' => 1,
        'columns' => 
