    ...
    <form class="form" method="post" action="/ajax/register.php">
        ...
        <div class="mb-3">
            ...
            <select id="education" class="form-select" name="UF_EDUCATION" required>
                <option value=""></option>
                <option value="Среднее профессиональное – квалифицированный рабочий, служащий">Среднее профессиональное – квалифицированный рабочий, служащий</option>
                <option value="Среднее профессиональное – специалист среднего звена">Среднее профессиональное – специалист среднего звена</option>
                <option value="Среднее профессиональное – студент (обучаюсь)">Среднее профессиональное – студент (обучаюсь)</option>
                ...
                <option value="Высшее профессиональное – аспирантура">Высшее профессиональное – аспирантура</option>
                <option value="Высшее профессиональное – докторантура">Высшее профессиональное – докторантура</option>
                <option value="Высшее профессиональное – студент (обучаюсь)">Высшее профессиональное – студент (обучаюсь)</option>
            </select>
        </div>
        <div class="mb-3">
